...
export default function UniversalIDCard({ student, school }: UniversalIDCardProps) {
  const themeColor = school?.theme_color || '#7c3aed';
  
  // Payload for automation systems
  const qrValue = `LEARNBEE|${school?.id || 'SCHOOL'}|${student.id}`;
  ...
  return (
    <div className="id-card-printable" style={cardStyle}>
      ...
      <div style={headerStyle}>
        <div style={{ fontSize: '12px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
      ...
      <div style={qrSectionStyle}>
        ...
        <div style={qrContainerStyle}>
          ...
          <div style={{ 
            position: 'absolute', 
            top: 'calc(50% + 6px)', // Adjusted for "Scan for Access" text
            left: '50%', 
      ...
      <div style={{ padding: '0 12px 12px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
          ...
          <div style={moduleIconStyle}>
            <ClipboardCheck size={8} /> Exam Hall
          </div>
        </div>
      </div>
